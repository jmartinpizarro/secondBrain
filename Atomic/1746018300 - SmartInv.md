...
**SmartInv** es un software de predicción de stock de retail, inicialmente orientado a PYMES. Se busca generar modelos de inteligencia artificial personalizables para cada empresa con los datos propios. **La propuesta de valor es un software único para cada empresa.**

**Dominio**: www.smartinv.es - Hostinger

## Primer Prototipo

La parte más importante de un negocio con inventario es saber qué va a tener que comprar el próximo día, semana, mes... Lo ideal es empezar por esa funcionalidad, hacerla la más práctica posible (y agradable para que parezca que la interfaz está llena de cosas) y luego iterar a partir de ahí.
...
- [**DatUp**](https://datup.ai/en): tiene varias soluciones a varios problemas: **Planificación de Demanda**, **Software de manejo de inventario** y **Supply&Demand Orchester**.