La **interfaz de usuario** es el canal a través del cual se produce la comunicación entre el usuario y el dispositivo. Esta interfaz debe de diseñarse para que sea eficiente y eficaz.
Hay varios tipos:
